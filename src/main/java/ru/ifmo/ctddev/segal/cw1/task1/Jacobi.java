...
public class Jacobi {
    ...
    public static FunctionalMatrix createTask1(List<Double> K, List<Double> D) {
        ...
        functionalMatrix.set(0, 0, args -> 1 - 2 * K.get(0) * args.get(0) * args.get(4));
        ...
        functionalMatrix.set(1, 1, args -> 1 - K.get(1) * args.get(4));
        ...
        functionalMatrix.set(2, 2, args -> 1 - 2 * K.get(2) * args.get(2) * Math.pow(args.get(4), 3D));
        ...
        functionalMatrix.set(3, 3, args -> 1 - D.get(3));
        ...
        functionalMatrix.set(4, 4, args -> 1D);
