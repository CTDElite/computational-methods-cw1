...
public class Task {
    ...
    public static FunctionalVector task2(List<Double> K, List<Double> D, List<Double> P) {
        FunctionalVector functionalVector = new FunctionalVector(5);

        functionalVector.set(0, args -> args.get(3) * args.get(3) - K.get(0) * args.get(0) * args.get(0) * args.get(4));
